...
gboolean nm_platform_ethtool_get_link_autoneg (NMPlatform *self, const char *ifname);
gboolean nm_platform_ethtool_get_link_speed (NMPlatform *self, const char *ifname, guint32 *out_speed);
gboolean nm_platform_ethtool_get_link_duplex (NMPlatform *self, const char *ifname, const char **out_duplex);
